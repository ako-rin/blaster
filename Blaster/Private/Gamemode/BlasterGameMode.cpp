...
{
	bDelayedStart = true; // waiting to start state
}
...
void ABlasterGameMode::RequestSpawn(class ACharacter* ElimmedCharacter,
	class AController* ElimmedController)
{
	if (ElimmedCharacter)
	{
